...
ActiveRecord::Schema.define(version: 2021_01_05_165527) do
  ...
  create_table "reasons", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.bigint "cancellation_category_id"
    t.index ["cancellation_category_id"], name: "index_reasons_on_cancellation_category_id"
  ...
  add_foreign_key "reasons", "cancellation_categories"
