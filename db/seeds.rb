...
ride1 = Ride.create(organization_id: org1.id, rider_id: rider1.id ,  pick_up_time: "2022-02-19 15:30:00" , start_location_id: loc5.id , end_location_id: loc12.id , ride_category_id: ride_category1.id, status: "pending")
ride2 = Ride.create(organization_id: org1.id, rider_id: rider2.id ,  pick_up_time: "2022-02-22 08:30:00" ,   start_location_id: loc6.id , end_location_id: loc14.id, ride_category_id: ride_category2.id, status: "pending")
ride3 = Ride.create(organization_id: org1.id, rider_id: rider3.id ,  pick_up_time: "2022-02-23 12:15:00" ,  start_location_id: loc7.id , end_location_id: loc15.id , ride_category_id: ride_category4.id, status: "approved")
ride4 = Ride.create(organization_id: org2.id, rider_id: rider4.id ,  pick_up_time: "2022-03-11 14:30:00" , start_location_id: loc8.id , end_location_id: loc13.id , ride_category_id: ride_category4.id, status: "approved")

Ride.create(organization_id: org1.id, rider_id: rider1.id , driver_id: driver1.id , pick_up_time: "2022-02-19 15:30:00" , start_location_id: loc5.id , end_location_id: loc12.id , ride_category_id: ride_category1.id, status: "scheduled")
Ride.create(organization_id: org1.id, rider_id: rider2.id , driver_id: driver2.id , pick_up_time: "2022-02-22 08:30:00" ,   start_location_id: loc6.id , end_location_id: loc14.id , ride_category_id: ride_category2.id, status: "scheduled")
Ride.create(organization_id: org1.id, rider_id: rider3.id , driver_id: driver3.id , pick_up_time: "2022-02-23 12:15:00" ,  start_location_id: loc7.id , end_location_id: loc15.id , ride_category_id: ride_category3.id, status: "scheduled")
Ride.create(organization_id: org2.id, rider_id: rider4.id , driver_id: driver4.id , pick_up_time: "2022-03-11 14:30:00" , start_location_id: loc8.id , end_location_id: loc13.id , ride_category_id: ride_category4.id, status: "scheduled")

Ride.create(organization_id: org1.id, rider_id: rider1.id , driver_id: driver1.id , pick_up_time: "2022-02-19 15:30:00" , start_location_id: loc5.id , end_location_id: loc12, ride_category_id: ride_category1.id, status: "scheduled")
Ride.create(organization_id: org1.id, rider_id: rider2.id , pick_up_time: "2022-02-22 08:30:00" ,   start_location_id: loc6.id , end_location_id: loc14.id , ride_category_id: ride_category2.id, status: "pending")
Ride.create(organization_id: org1.id, rider_id: rider3.id , pick_up_time: "2022-02-23 12:15:00" ,  start_location_id: loc7.id , end_location_id: loc15.id , ride_category_id: ride_category3.id, status: "pending")
Ride.create(organization_id: org2.id, rider_id: rider4.id , driver_id: driver4.id , pick_up_time: "2022-03-11 14:30:00" , start_location_id: loc8.id , end_location_id: loc13.id , ride_category_id: ride_category4.id, status: "completed")

Ride.create(organization_id: org1.id, rider_id: rider1.id ,  pick_up_time: "2022-02-20 15:30:00" , start_location_id: loc5.id , end_location_id: loc12.id , ride_category_id: ride_category1.id, status: "pending")
Ride.create(organization_id: org1.id, rider_id: rider2.id ,  pick_up_time: "2022-02-23 08:30:00" ,   start_location_id: loc6.id , end_location_id: loc14.id , ride_category_id: ride_category2.id, status: "pending")

Ride.create(organization_id: org1.id, rider_id: rider3.id ,  pick_up_time: "2022-02-24 12:15:00" ,  start_location_id: loc7.id , end_location_id: loc15.id , ride_category_id: ride_category1.id, status: "approved")
Ride.create(organization_id: org2.id, rider_id: rider4.id ,  pick_up_time: "2022-03-14 14:30:00" , start_location_id: loc8.id , end_location_id: loc13.id , ride_category_id: ride_category2.id, status: "approved")

Ride.create(organization_id: org1.id, rider_id: rider1.id , driver_id: driver1.id , pick_up_time: "2022-02-20 15:30:00" , start_location_id: loc5.id , end_location_id: loc12.id , ride_category_id: ride_category1.id, status: "scheduled")
Ride.create(organization_id: org1.id, rider_id: rider2.id , driver_id: driver2.id , pick_up_time: "2022-02-23 08:30:00" ,   start_location_id: loc6.id , end_location_id: loc14.id , ride_category_id: ride_category2.id, status: "scheduled")
Ride.create(organization_id: org1.id, rider_id: rider3.id , driver_id: driver3.id , pick_up_time: "2022-02-24 12:15:00" ,  start_location_id: loc7.id , end_location_id: loc15.id , ride_category_id: ride_category3.id, status: "scheduled")
Ride.create(organization_id: org2.id, rider_id: rider4.id , driver_id: driver4.id , pick_up_time: "2022-03-15 14:30:00" , start_location_id: loc8.id , end_location_id: loc13.id , ride_category_id: ride_category4.id, status: "scheduled")

Ride.create(organization_id: org1.id, rider_id: rider1.id , driver_id: driver1.id , pick_up_time: "2022-02-22 15:30:00" , start_location_id: loc5.id , end_location_id: loc12.id , ride_category_id: ride_category1.id, status: "scheduled")
Ride.create(organization_id: org1.id, rider_id: rider2.id , pick_up_time: "2022-02-25 08:30:00" ,   start_location_id: loc6.id , end_location_id: loc14.id , ride_category_id: ride_category2.id, status: "pending")
Ride.create(organization_id: org1.id, rider_id: rider3.id , pick_up_time: "2022-02-25 12:15:00" ,  start_location_id: loc7.id , end_location_id: loc15.id , ride_category_id: ride_category3.id, status: "pending")
Ride.create(organization_id: org2.id, rider_id: rider4.id , driver_id: driver4.id , pick_up_time: "2022-03-14 14:30:00" , start_location_id: loc8.id , end_location_id: loc13.id , ride_category_id: ride_category4.id, status: "completed")
